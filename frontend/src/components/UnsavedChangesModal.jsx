    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6">
        ...
        <div className="flex flex-col sm:flex-row gap-2 justify-end">
          <button
            onClick={onStay}
            className="order-3 sm:order-1 px-4 py-2.5 text-sm border border-gray-200 rounded-xl text-gray-600 hover:bg-gray-50 font-medium"
          >
            Stay on Page
          </button>
          <button
            onClick={onLeave}
            className="order-2 px-4 py-2.5 text-sm border border-red-200 text-red-600 rounded-xl hover:bg-red-50 font-medium"
          >
            Leave Anyway
          </button>
          <button
            onClick={onSaveDraft}
            className="order-1 sm:order-3 px-5 py-2.5 text-sm bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700"
          >
            Save Draft &amp; Leave
          </button>
        </div>
